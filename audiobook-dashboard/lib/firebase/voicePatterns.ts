...
const starterPatterns: Array<Omit<VoicePattern, "id" | "updated_at" | "created_at">> = [
  {
    ...
    reference_audio_path: "local-narrator/voice-approved/PG2026/older_woman/older-woman-reference.v001.wav",
    reference_text: "The kettle clicked off, but she did not move right away. Experience had taught her which silences deserved respect and which ones needed a door slammed through them.",
  ...
  },
  {
    ...
    reference_audio_path: "local-narrator/voice-approved/PG2026/middle_aged_woman/middle-aged-woman-reference.v001.wav",
    reference_text: "She set the keys on the counter and chose her words carefully. Someone had to stay practical, and apparently today that someone was her.",
    reference_status: "approved",
    sort_order: 20,
  },
  {
    ...
    reference_audio_path: "local-narrator/voice-approved/PG2026/young_woman/young-woman-reference.v001.wav",
    reference_text: "She checked the message twice, then smiled despite herself. Bad ideas had a way of sounding like destiny when nobody sensible was nearby.",
    reference_status: "approved",
    sort_order: 30,
  },
  {
    ...
    reference_audio_path: "local-narrator/voice-approved/PG2026/teenage_woman/teenage-woman-reference.v001.wav",
    reference_text: "She rolled her eyes before she could stop herself. Fine, maybe it was dangerous, but pretending not to care was basically a survival skill.",
    reference_status: "approved",
    sort_order: 40,
  },
  {
