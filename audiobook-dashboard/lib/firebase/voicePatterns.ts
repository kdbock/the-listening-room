...
const starterPatterns: Array<Omit<VoicePattern, "id" | "updated_at" | "created_at">> = [
  ...
  },
  {
    ...
    detail: "Needs neutral reference WAV",
    gender: "neutral",
    voice: "",
    age_feel: "Adult",
...
const legacyStarterUpdates: Array<Partial<VoicePattern> & { value: string }> = [
  ...
  { value: "protective_older_masculine", label: "Older man", detail: "Needs masculine reference WAV", age_feel: "Older adult", sort_order: 70 },
  { value: "warm_adult_masculine", label: "Middle-aged man", detail: "Needs masculine reference WAV", age_feel: "Middle-aged adult", sort_order: 80 },
  { value: "polished_dangerous_masculine", label: "Polished man", detail: "Needs masculine reference WAV", age_feel: "Adult / older adult", sort_order: 90 },
